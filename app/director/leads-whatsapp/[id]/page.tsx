...
export default async function LeadFichaPage({ params }: { params: { id: string } }) {
  ...
  if (!conv) {
    return (
      <div className="p-8 max-w-7xl mx-auto space-y-4">
        <h2 className="text-xl font-bold">Conversación no encontrada</h2>
        <Link href="/director/leads-whatsapp">
        ...
        <div className="flex items-center gap-4">
          <Link href="/director/leads-whatsapp">
            <Button variant="outline" size="sm" className="h-8">
              <ArrowLeft className="w-4 h-4 mr-2" /> Volver a Leads
            </Button>
          </Link>
