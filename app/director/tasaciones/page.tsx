...
export default function TasacionesPage() {
  ...
  const [pastValuations, setPastValuations] = useState<any[]>([])
            ...
            <div className="bg-accent/5 rounded-3xl border border-accent/20 p-8 space-y-8 relative overflow-hidden">
              ...
              <div className="grid md:grid-cols-3 gap-6 relative">
                 <div className="bg-card/50 p-6 rounded-2xl border border-accent/10 text-center">
                    ...
                    <p className="text-4xl font-black text-accent">USD {valuationResult.suggested_price?.toLocaleString()}</p>
                 </div>
                 <div className="bg-card/50 p-6 rounded-2xl border border-accent/10 text-center">
                 ...
                 <div className="bg-card/50 p-6 rounded-2xl border border-accent/10 text-center">
                    ...
                    <p className="text-2xl font-bold">{valuationResult.price_per_sqm?.toLocaleString()}</p>
                 </div>
              </div>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Obtén valuaciones precisas basadas en IA y datos reales del mercado Argentino.
          </p>
        </div>
                ...
                pastValuations.map((v) => (
                  <div key={v.id} className="group p-4 rounded-xl border border-accent/5 bg-background/40 hover:border-accent/30 transition-all">
                    ...
                    <div className="flex items-center justify-between mt-3 pt-3 border-t border-accent/5">
                      <p className="font-black text-accent">USD {v.result_data?.suggested_price?.toLocaleString()}</p>
