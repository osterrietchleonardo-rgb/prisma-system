  ...
  return (
    <html lang="es">
      <head>
        ...
        <title>Sistema · Acceso Restringido</title>
      </head>
      <body style={{ margin: 0, background: "#070B14", display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh", fontFamily: "system-ui, sans-serif" }}>
        <div style={{
          width: "100%",
          maxWidth: 420,
          padding: "48px 40px",
