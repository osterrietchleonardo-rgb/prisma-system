...
export default function AsesorLeadDetailPage() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      router.push("/asesor/leads")   // ← vuelve al listado del asesor
    } finally {
      setLoading(false)
    }
  }, [id, router])
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="border-accent/10 bg-card/30 backdrop-blur-md rounded-2xl overflow-hidden shadow-lg border-l-4 border-l-accent">
            ...
            <CardContent className="px-8 pb-8 space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <h4 className="text-xs uppercase font-bold text-accent flex items-center gap-2 tracking-wider">
                    <User className="h-3.5 w-3.5" /> Información de Contacto
                  </h4>
              ...
              <div className="mt-4">
                ...
                >
                  <span className="flex items-center gap-2">Visualizar JSON original de Tokko (Debug)</span>
        ...
        <div className="space-y-6">
          {lead.chat_analysis && Object.keys(lead.chat_analysis).length > 0 && (
            <Card className="border-accent/20 bg-accent/5 backdrop-blur-md rounded-2xl overflow-hidden shadow-lg border-l-4 border-l-accent">
