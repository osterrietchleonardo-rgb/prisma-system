...
export default function PublicLayout({
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background selection:bg-accent/30">
      {/* HEADER FLOTANTE - Solo se muestra si NO es una página de Auth */}
      {!isAuthPage && (
        <div className="fixed top-0 md:top-6 z-[100] px-0 md:px-6 w-full pointer-events-none animate-in fade-in slide-in-from-top-4 duration-500">
      ...
      {/* FOOTER - Solo se muestra si NO es una página de Auth */}
      {!isAuthPage && (
