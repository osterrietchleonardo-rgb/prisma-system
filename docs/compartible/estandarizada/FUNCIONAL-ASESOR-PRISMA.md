...
- **Cómo se abre un proceso nuevo:** desde **"Nueva Actividad"**, elegís el mismo cliente y cargás la actividad que te falta (por ejemplo, un Prelisting si ya lo tenías como Comprador en Prebuying). O más directo: abrís la tarjeta que ya tiene, y en el panel te aparecen botones **"Abrir proceso de…"** con las opciones que ese cliente todavía no tiene (hasta tres, una por cada proceso que le falte). Tocás una, se abre el formulario con el cliente ya cargado y arranca directo en la etapa que le corresponde (Prelisting o Captación si ofrece una propiedad, Prebuying si busca una). **La tarjeta que ya tenías no se mueve** al hacer esto.
