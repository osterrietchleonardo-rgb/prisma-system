...
**EBITDA y Flujo de Caja Libre (FCL):** **EBITDA** = utilidad operativa + **Depreciación/Amortización** (categoría de gasto nueva; se vuelve a sumar porque no es salida de caja). **FCL** = EBITDA − impuestos − **CAPEX** (categoría "Inversiones/CAPEX" nueva) − **variación de capital de trabajo** (campo manual). Importante: el **CAPEX no es gasto del Estado de Resultado** (es inversión) → se excluye del EBIT, de los KPIs de gastos y de la torta de categorías; solo impacta el FCL. La UI muestra el "puente" (utilidad operativa → +D&A → EBITDA → −impuestos → −CAPEX → −Δ capital de trabajo → FCL) con margen EBITDA% y FCL% sobre ventas. EBITDA y FCL también se le pasan al experto IA para que los comente.
