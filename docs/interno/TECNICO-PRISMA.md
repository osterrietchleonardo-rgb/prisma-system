...
- **Pedidos de asesores de Central (16-sep-2026, rama `feat/acm-pedidos-asesores`):** cuatro cambios, ninguno toca SQL.
  ...
  - ⚠️ **Redeploy del extractor en EasyPanel** para que devuelva `html`; sin eso, los avisos fuera de la red entran sin fotos cuando Tier 1 está bloqueado (en Vercel, casi siempre).
