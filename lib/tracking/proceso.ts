...
const COLOR_OFRECE = "bg-indigo-500/25 text-indigo-800 dark:text-indigo-400 border-indigo-500/50";
const COLOR_BUSCA = "bg-violet-500/25 text-violet-800 dark:text-violet-400 border-violet-500/50";
...
const BADGES: Record<ProcesoNegocio | "sin-definir", { label: string; className: string }> = {
  ...
  "sin-definir": {
    label: "SIN DEFINIR",
    className: "bg-amber-500/25 text-amber-800 dark:text-amber-400 border-amber-500/50",
  },
};
