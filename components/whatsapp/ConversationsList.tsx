            ...
            {filtered.map((conv) => (
              ...
              >
                <div className="relative flex-shrink-0">
                  ...
                  {conv.bot_active ? (
                    <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-primary text-primary-foreground rounded-full border-2 border-background flex items-center justify-center" title="Bot activo">
                      <Bot className="w-3 h-3" />
                    </div>
                  ) : (
                    <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-muted-foreground text-background rounded-full border-2 border-background flex items-center justify-center" title="Bot pausado">
