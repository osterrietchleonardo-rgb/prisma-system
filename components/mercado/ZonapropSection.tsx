    ...
    <div className="flex items-center gap-1.5">
      ...
      <span
        className={`inline-flex items-center gap-0.5 text-xs font-bold ${
          isPos ? "text-emerald-700 dark:text-emerald-400" : "text-red-600 dark:text-red-400"
        }`}
      >
    ...
    <div className="rounded-2xl border bg-card/50 backdrop-blur p-5 flex flex-col gap-4">
      ...
      <div className="flex items-start justify-between gap-2">
        ...
        {zona.mes_reporte ? (
          ...
          <Badge variant="outline" className="text-[10px] text-amber-700 dark:text-amber-400 border-amber-500/30 shrink-0">
            Sin reporte
          </Badge>
        )}
      </div>
      ...
      {!zona.parseado_ok ? (
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-2 text-xs text-amber-800 dark:text-amber-400 bg-amber-500/10 border border-amber-500/20 rounded-lg px-3 py-2">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-violet-600 dark:text-violet-400 tabular-nums">
