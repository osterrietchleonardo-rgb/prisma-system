    ...
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <CardContent className="h-[250px]">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data}>
              ...
              />
              {/* El dato llega como `gci`: pedía `facturacion`, que no existe, y el gráfico salía vacío. */}
              <Area type="monotone" dataKey="gci" name="Facturación" stroke="#D4A373" strokeWidth={3} fillOpacity={1} fill="url(#colorFact)" />
            </AreaChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
      ...
      <Card className="md:col-span-2 lg:col-span-1 border-accent/10 bg-card/50 backdrop-blur-sm">
        <CardHeader>
          ...
          <CardDescription>Propiedades en cartera a fin de mes y % que se cerró</CardDescription>
        </CardHeader>
        <CardContent className="h-[250px]">
          <ResponsiveContainer width="100%" height="100%">
            {/* ComposedChart: un BarChart no dibuja la línea de rotación. */}
            <ComposedChart data={data}>
              ...
              />
              <Legend verticalAlign="top" align="right" iconType="circle" wrapperStyle={{ fontSize: '10px' }} />
              <Bar yAxisId="left" dataKey="cartera" name="Cartera a fin de mes" fill="#8884d8" opacity={0.5} radius={[4, 4, 0, 0]} barSize={30} />
